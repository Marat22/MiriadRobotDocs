...
Планировщик занимается тем, чтобы эти функции вызывались.
...
Публичные функции:
- запустить_планировщик() — функция, которая с определённой периодичностью бесконечно вызывает определённые функции, описанные выше.
